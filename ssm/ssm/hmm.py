...
from ssm.messages import hmm_expected_states, hmm_filter, hmm_sample, viterbi, hmm_expected_states2
...
class HMM(object):
    ...
    def __init__(self, K, D, M=0, init_state_distn=None,
        ...
        transition_classes = dict(
            ...
            stateinputdriven=trans.StateInputDrivenTransitions,
    ...
    @ensure_args_not_none
    def expected_states2(self, data, input=None, mask=None, tag=None):
        pi0 = self.init_state_distn.initial_state_distn
        Ps = self.transitions.transition_matrices(data, input, mask, tag)
        log_likes = self.observations.log_likelihoods(data, input, mask, tag)
        return hmm_expected_states2(pi0, Ps, log_likes)
